...
/**
 * Protobuf type {@code im.PushResponse}
 */
public final class PushResponse extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:im.PushResponse)
    ...
    getDescriptor() {
        return violet.gateway.common.proto_gen.im.Im.internal_static_im_PushResponse_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    internalGetFieldAccessorTable() {
        return violet.gateway.common.proto_gen.im.Im.internal_static_im_PushResponse_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        violet.gateway.common.proto_gen.im.PushResponse.class, violet.gateway.common.proto_gen.im.PushResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof violet.gateway.common.proto_gen.im.PushResponse)) {
            return super.equals(obj);
        }
        violet.gateway.common.proto_gen.im.PushResponse other = (violet.gateway.common.proto_gen.im.PushResponse) obj;
    ...
    public static violet.gateway.common.proto_gen.im.PushResponse parseFrom(
    ...
    public static violet.gateway.common.proto_gen.im.PushResponse parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static violet.gateway.common.proto_gen.im.PushResponse parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static violet.gateway.common.proto_gen.im.PushResponse parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
                .parseDelimitedWithIOException(PARSER, input);
    }

    public static violet.gateway.common.proto_gen.im.PushResponse parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(violet.gateway.common.proto_gen.im.PushResponse prototype) {
    ...
    public static final class Builder extends
            ...
            // @@protoc_insertion_point(builder_implements:im.PushResponse)
            violet.gateway.common.proto_gen.im.PushResponseOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return violet.gateway.common.proto_gen.im.Im.internal_static_im_PushResponse_descriptor;
        }
        ...
        // Construct using violet.gateway.common.proto_gen.im.PushResponse.newBuilder()
        private Builder() {
        ...
        public violet.gateway.common.proto_gen.im.PushResponse getDefaultInstanceForType() {
            return violet.gateway.common.proto_gen.im.PushResponse.getDefaultInstance();
        }

        public violet.gateway.common.proto_gen.im.PushResponse build() {
            violet.gateway.common.proto_gen.im.PushResponse result = buildPartial();
        ...
        public violet.gateway.common.proto_gen.im.PushResponse buildPartial() {
            violet.gateway.common.proto_gen.im.PushResponse result = new violet.gateway.common.proto_gen.im.PushResponse(this);
            if (baseRespBuilder_ == null) {
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof violet.gateway.common.proto_gen.im.PushResponse) {
                return mergeFrom((violet.gateway.common.proto_gen.im.PushResponse) other);
            } else {
        ...
        public Builder mergeFrom(violet.gateway.common.proto_gen.im.PushResponse other) {
            if (other == violet.gateway.common.proto_gen.im.PushResponse.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            violet.gateway.common.proto_gen.im.PushResponse parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (violet.gateway.common.proto_gen.im.PushResponse) e.getUnfinishedMessage();
        ...
        // @@protoc_insertion_point(builder_scope:im.PushResponse)
    }

    // @@protoc_insertion_point(class_scope:im.PushResponse)
    private static final violet.gateway.common.proto_gen.im.PushResponse DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new violet.gateway.common.proto_gen.im.PushResponse();
    }

    public static violet.gateway.common.proto_gen.im.PushResponse getDefaultInstance() {
