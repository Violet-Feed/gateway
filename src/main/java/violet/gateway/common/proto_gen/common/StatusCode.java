...
public enum StatusCode
    ...
    public static StatusCode forNumber(int value) {
        switch (value) {
            ...
            case 1002:
                return Param_Error;
            case 1003:
                return OverFrequency_Error;
            case 1004:
                return OverLimit_Error;
            case 1005:
                return Duplicate_Error;
            case 1006:
                return RetryTime_Error;
            case 1007:
    ...
    getDescriptor() {
        return violet.gateway.common.proto_gen.common.Common.getDescriptor().getEnumTypes().get(0);
    }
