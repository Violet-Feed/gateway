...
/**
 * Protobuf enum {@code http.StatusCode}
 */
public enum StatusCode
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return violet.gateway.common.proto_gen.http.Http.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:http.StatusCode)
}
